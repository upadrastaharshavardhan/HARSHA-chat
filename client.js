...
var frontpage = [
	"                           
	  __   __      _____      __ __     ______    __   __      _____      _____  __   __    _____   _______   
 /\_\ /_/\    /\___/\    /_/\__/\  / ____/\  /\_\ /_/\    /\___/\    /\ __/\/\_\ /_/\  /\___/\/\_______)\ 
( ( (_) ) )  / / _ \ \   ) ) ) ) ) ) ) __\/ ( ( (_) ) )  / / _ \ \   ) )__\( ( (_) ) )/ / _ \ \(___  __\/ 
 \ \___/ /   \ \(_)/ /  /_/ /_/_/   \ \ \    \ \___/ /   \ \(_)/ /  / / /   \ \___/ / \ \(_)/ / / / /     
 / / _ \ \   / / _ \ \  \ \ \ \ \   _\ \ \   / / _ \ \   / / _ \ \  \ \ \_  / / _ \ \ / / _ \ \( ( (      
( (_( )_) ) ( (_( )_) )  )_) ) \ \ )____) ) ( (_( )_) ) ( (_( )_) )  ) )__/( (_( )_) | (_( )_) )\ \ \     
 \/_/ \_\/   \/_/ \_\/   \_\/ \_\/ \____\/   \/_/ \_\/   \/_/ \_\/   \/___\/\/_/ \_\/ \/_/ \_\/ /_/_/     
                                                                                                          
	"",
	"",
	"Welcome to harsha.chat, a minimal, distraction-free chat application.",
	"Channels are created, joined and shared with the url, create your own channel by changing the text after the question mark.",
	"If you wanted your channel name to be 'your-channel': [harsha-chat](https://hack.chat/?your-channel)",
	
	"And here's a random one generated just for you: ?" + Math.random().toString(36).substr(2, 8),
	"",
	
	"No message history is retained on the harsha.chat server."
].join("\n");
